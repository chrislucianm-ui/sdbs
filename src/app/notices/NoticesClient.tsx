...
export default function NoticesClient({ initialNotices = [] }: NoticesClientProps) {
  ...
  // Filter notices by search query and category tab
        ...
        {filteredNotices.length === 0 && (
          <div className="text-center py-20 bg-white rounded-2xl border border-slate-200 shadow-sm flex flex-col items-center justify-center gap-4 max-w-lg mx-auto">
            ...
            <div className="space-y-1">
              <h3 className="font-serif font-bold text-lg text-navy-900">No matching notices found</h3>
